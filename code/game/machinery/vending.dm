...
//This one of Fallout 13
/obj/machinery/vending/nukacolavend
	name = "\improper Nuka-Cola vending machine"
	desc = "Warning: If you tamper with this unit you will have to answer to the Nuka-Cola Corporation."
	icon_state = "nuka_vending"
	icon_deny = "nuka_vending-deny"
	products = list(/obj/item/weapon/reagent_containers/food/drinks/nukacola = 3)