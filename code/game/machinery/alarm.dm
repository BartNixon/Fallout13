...
/obj/machinery/alarm
	...
	var/alarm_sound = 'sound/f13effects/area_alarm.ogg'
...
/obj/machinery/alarm/update_icon()
	...
	switch(max(danger_level, alarm_area.atmosalm))
		...
		if (1)
			src.icon_state = "alarm1" //alarm1 is yellow alarm
		if (2)
			src.icon_state = "alarm2"
			playsound(src.loc, alarm_sound, 50, 0, 10)
...
/obj/machinery/firealarm/proc/alarm()
	...
	if(!A.fire)
		A.firealert(src)
	//playsound(src.loc, 'sound/ambience/signal.ogg', 75, 0) //NEVER NEVER USE THIS! PLEASE! BELIEVE!
	return
