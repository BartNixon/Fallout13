...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if ("explosion") soundin = pick('sound/f13effects/explo1.ogg','sound/f13effects/explo2.ogg')
			if ("distexplosion") soundin = pick('sound/f13effects/distantexplo01.ogg','sound/f13effects/distantexplo02.ogg','sound/f13effects/distantexplo03.ogg','sound/f13effects/distantexplo04.ogg')
