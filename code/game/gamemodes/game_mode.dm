...
/datum/game_mode/proc/send_intercept()
	...
	print_command_report(intercepttext,"Main Quest begins!")
	priority_announce("It's your chance to save the humanity or to destroy the remains of it.", "It's time to make your choice.", 'sound/f13music/quest.ogg')
