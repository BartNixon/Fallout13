...
/datum/controller/gameticker/proc/pregame()
	...
	login_music = pickweight(list('sound/f13music/newvegasshow1.ogg' = 49, 'sound/f13music/newvegasshow2.ogg' = 49, 'sound/f13music/newvegasshow3.ogg' = 49, 'sound/f13music/newvegasshow4.ogg' = 49, 'sound/f13music/newvegasshow5.ogg' = 49, 'sound/f13music/newvegasshow6.ogg' = 49, 'sound/f13music/newvegasshow7.ogg' = 49)) // choose title music!
	if(events.holiday == "April Fool's Day")
		login_music = 'sound/f13music/mysteriousstranger.ogg'
...
/datum/controller/gameticker/proc/setup()
	...
	spawn(0)//Forking here so we dont have to wait for this to finish
		...
		for(var/obj/effect/landmark/start/S in landmarks_list)
			...
			if (S.name != "AI")
				qdel(S)
		world << "<FONT color='orange'><B>Enjoy the game!</B></FONT>"
		world << sound('sound/f13music/gamestart.ogg') // Skie
