...
/datum/game_mode/traitor
	...
	protected_jobs = list("Warden", "Head of Security", "Captain")//"Detective", "Security Officer", AI", Currently out of the list as malf does not work for shit. Cops can be dirty too.
	required_players = 0
	required_enemies = 1
