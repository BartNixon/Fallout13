...
turf/unsimulated/wall/splashscreen/New()
	.=..()
	name = "Fallout 13"
	desc = "Welcome to Fallout 13!<br>Meet our laborious team:<br>BartNixon (Creator, Manager, Spriter, Coder)<br>Ivan_mrr (Spriter, Creative Director)<br>Nienhaus (Spriter, Ambassador)<br>MrSnapwalk (Spriter)<br>WalterJe (Spriter)<br>WB (Coder)<br>Lydee (Sprites and support)<br>Gyaviste (Code and support)<br>Hold_Me_Please (Fix and support)<br>/TG/Station 13 team<br>And all the others who made our dream come true."
