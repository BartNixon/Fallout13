...
/proc/new_station_name()
	...
	//Rare: Pre-Prefix
	if (prob(10))
		name = pick("Mutants of", "Brotherhood of", "Raiders of", "Ghouls of", "Merchants of", "Followers of", "Soldiers of", "Traders of", "Slaves of", "Outcasts of", "Religious", "Atheist", "Guild of", "Squad of", "Mad", "State of", "Ultra quest of", "Secret knowledge of", "Top Secret of", "Scientists of", "Gun Runners of", "Union of", "Alliance of", "Main", "Government of", "Tribe of", "Rangers of", "Gang of", "Experiment of", "Remnants of")
	...
	switch(events.holiday)
		//get normal name
		if(null,"",0)
			name = pick("", "Enclave", "Steel", "Ghoul", "Crimson", "Regulator", "Super Mutant", "The Apocalypse", "Ranger", "Psychic", "Underground", "Conspiracy", "Rogue", "New California Republic", "Vault Tec", "Nuka Cola", "Sunset Sarsaparilla", "Vault Dweller", "The Chosen One", "The Lone Wanderer", "Courier", "North", "West", "East", "South", "Overseer", "Elder", "President", "Caesar's", "Robot", "Imperial", "Unidentified", "Sentry bot", "Deathclaw", "Liberty Prime", "Mister Handy", "Control", "Eyebot", "Brahmin", "Glowing One", "Gecko", "Mole rat","Tunnel Snake","Skeleton","Rad scorpion", "Fat Man", "Gentleman", "Capitalist", "Communist", "Radroach", "Protectron", "Robobrain", "Mister Gutsy", "PDQ-88b Securitron", "Dwarf", "G.E.C.K.", "Terminal", "RobCo", "REPCONN", "Vertibird", "Supply", "Military", "Mirelurk", "GNR", "Science", "Tribesmen")
			if(name)
				new_station_name += name + " "

		//For special days like christmas, easter, new-years etc ~Carn
		if("Friday the 13th")
			name = pick("Cannibal","Friday","Evil","Torture","Murder","Deathly","Stabby")
			new_station_name += name + " "
			random = 13
		else
