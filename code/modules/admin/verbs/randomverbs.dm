...
/client/proc/cmd_admin_create_centcom_report()
	...
	if(!holder)
		src << "Only administrators may use this command."
		return
	var/input = input(usr, "Please enter anything you want. Anything. Serious.", "Radio Broadcast: Transmit", "") as message|null
	if(!input)
		return
...
/client/proc/roll_dice()
	...
	if(alert("Do you want to inform the players about your game?","Admin dice","Yes", "No") == "Yes")
		world << "<h2 style='text-color:#A50400'>The dice are being rolled by the Game Master!</h2>"

	var/result = roll(dice)

	if(alert("Do you want to inform the players about the result?","Admin dice","Yes", "No") == "Yes")
		world << "<h2 style='text-color:#A50400\'>The Game Master has rolled [dice], the result is [result]</h2>"
...
/client/proc/credits()
	...
	output += "<br><h3><font face='Verdana'>[global_station_name]</font></h3>"
