...
var/global/list/ghost_forms = list("ghost","ghostking","ghostian","ghostlyian","skeleghost","ghost_red","ghost_black", \
...
/client/verb/pick_form()
	...
	var/new_form = input(src, "Choose your ghostly form:","Ghost editor",null) as null|anything in ghost_forms
	if(new_form)
...
/client/verb/pick_ghost_orbit()
	...
	if(!is_content_unlocked())	return
	var/new_orbit = input(src, "Choose your ghostly orbit:","Ghost editor",null) as null|anything in ghost_orbits
	if(new_orbit)
